...
switch ($requestMethod) {
    case 'POST':
        ...
        if ($requestURI === '/api/member/reg') {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                $sql1 = $mysqli->prepare("INSERT INTO usuarios (mobile, celular, password, real_name, spassword, url, token, data_cad, invite_code, invitation_code, tipo_pagamento) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
                $sql1->bind_param("sssssssssss", $nome_user, $celular, $senha, $real_name, $senha, $url, $token, $datadia, $afinveted, $afiliado, $tipo_pagamento)
                    or die('Essa buceta ta vinculando os parametros errado' . $sql1->error);
        ...
        if ($requestURI === '/api/finance/third/deposit') {
            if (isset($_COOKIE['token_user']) && !empty($_COOKIE['token_user'])) {
                ...
                if (mysqli_num_rows($resp) > 0) {
                    ...
                    $return_data_pix = phillyps_qrcode(
                        $data['amount'],
                        $datares['real_name'] ?? $datares['mobile'],
                        $datares['id'],
                        $clientIP
                    );
        ...
        if ($requestURI === '/api/member/slot/search') {
            ...
            // Consulta principal de jogos (mantida igual)
            if ($provedor == 0) {
            ...
            if ($provedor == 0) {
                ...
                $stmt->bind_param("is", $provedor, $searchTerm);
            }
    ...
    case 'GET':
                ...
                "data" => [
                    ...
                    "pop" => [
                        [
                            ...
                            "link" => "https://t.me/suportegrupoprime",
                            "oper" => "",
                            "sway" => 0,
                            "sort" => 3,
                            "state" => 1,
                    ...
                    "pool_forward" => "/",
                    "sort_jackpot" => $dataconfig['sort_jackpot'],
                    "requiredRegisterCPF" => "0",
                    "float" => [
                        [
                            "id" => "118325348452343390",
                            "ty" => "",
                            "name" => "拼多多",
                            "portal" => [
                                "h5",
                    ...
                    "authLogReg" => "1",
                    "banner_switch" => "0",
                    "homePopupStyle" => "4", // TIPO DO POPUP DE ANUNCIOS, NORMAL 1, TABS EM CIMA 2, TABS EM BAIXO 3, 4 NORMAL COM AS TABS NA DIREITA
                    "pCenterStyle" => "0",
                    "player_autoplay" => "1",
                    "googleH5Secret" => "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",
                    "banner_img" => "/uploads/appbaixar.png",
                    "pool_forward_name" => "/",
                    "banner_hidden_proxy" => "",
                    ...
                    "pool_forward_id" => "/",
                    "personal_information_real_name" => "0",
                    "hot_game_record_num" => "20000",
                    "marqueeTxt" => $dataconfig['marquee'],
                    "pool_switch" => "1",
                    "quickLogin" => "google",
                    "register_need_snapchat_switch" => "0",
                    "netsignal_switch" => "0",
                    ...
                    [
                        ...
                        "l" => [
                            ...
                            [
                                ...
                                "code" => "",
                                "pid" => "26595015200317",
                                "img" => "/image/Slots-Hacksaw.png.webp",
                                "automatic" => 1
                            ],
                            [
                                "id" => "36595015200314",
                                ...
                                "code" => "",
                                "pid" => "36595015200314",
                                "img" => "/image/Slots-ACEWIN.png.webp",
                                "automatic" => 0
                            ],
                            [
                                "id" => "26595015100306",
        ...
        if (parse_url($requestURI, PHP_URL_PATH) === '/api/member/slot/hotgame') {
            ...
            $page_size = isset($_GET['page_size']) ? intval($_GET['page_size']) : 10; // Número de itens por página
        ...
        if (parse_url($requestURI, PHP_URL_PATH) === '/api/promo/list') {
            ...
            $response = [
                ...
                "data" => [
                    ...
                    [
                        "static" => [
                            "list_web" => "/uploads/promocao8.webp",
                            "list_h5" => "/uploads/promocao8.webp",
                            "title_web" => "/uploads/promocao8.webp",
                            "title_h5" => "/uploads/promocao8.webp",
                            "display_mode" => 1,
                            "link_mode" => 1,
                            "link_url" => "web_login"
                        ],
                        "id" => "231401050555111581",
                        "title" => "roda da fortuna（不要改配置在测试）",
                        "state" => 2,
                        "flag" => "lucky",
                        "grade" => "2,2000,1001,1002,1003,1004,1005,1006,1007",
                        "login_af" => 1,
                        "login_bf" => 0,
                        "show_at" => 1733906040,
                        "show_end_at" => 1735630200,
                        "apply_terminal" => "1,2,3,4"
                    ]
                ],
                "msg" => null
            ];
                ...
                if (!empty($code) && !empty($game_type)) {
                    ...
                    if (mysqli_num_rows($resp) > 0) {
                        ...
                        if ($type == "API30") {
                            ...
                            $gameretur = pegarLinkJogoPlayFiver($provedor, $game_code, $datares['id'], $datares['saldo']);
            ...
            $response = [
                ...
                "data" => [
                    ...
                    [
                        ...
                        [
                            "static" => [
                                "list_web" => "/image/1721428600234..webp",
                                "list_h5" => "/image/1730417387828..webp",
                                "title_web" => "/image/1705398003881.webp",
                                "title_h5" => "/image/1705398015397.webp",
                                "share_h5" => "/image/1705485335738.webp",
                                "display_mode" => 1,
                                "link_mode" => 1,
                                "link_url" => "web_login"
                            ],
                            "id" => "231401050555111574",
                            "title" => "roda de dinheiro",
                            "state" => 2,
                            "flag" => "turntable",
                            "grade" => "34,1001,1002,1003,1004,1005,1006,1007,1008",
                            "login_af" => 3,
                            "login_bf" => 0,
                            "show_at" => 1730417389,
                            "show_end_at" => 0,
                        ...
                        [
                            "static" => [
                                ...
                                "display_mode" => 2,
                                "link_mode" => 2,
                                "link_url" => "https://t.me/suportegrupoprime"
                            ],
...
A empresa reserva-se o direito de modificar e encerrar o evento sem aviso prévio. A decisão final pertence à plataforma."
        ...
        // Rota de api/promo/detail
        if (parse_url($requestURI, PHP_URL_PATH) === '/api/promo/lucky/detail') {
            // if (isset($_COOKIE['token_user']) && !empty($_COOKIE['token_user'])) {
            $rotaEncontrada = true; // Rota encontrada
            // $qry = "SELECT * FROM usuarios WHERE token='" . $_COOKIE['token_user'] . "'";
            //   $resp = mysqli_query($mysqli, $qry);
                ...
                "data" => [
                    ...
                    "rules" => [
                        ...
                        "get_lucky_amount" => [
                            ...
                            [
                                "type" => 1,
                                "channel" => "3/26595015200314",
                                "ned_amount" => 10,
                                "get_amount" => 10,
                                "reward_type" => 0
                            ]
                        ],
                        "lucky_amount_expiry" => "day",
                        "task_type" => "day",
                        "promo_rule_json" => [
                            [
                                "content" => "1.Exclusivo para a primeira recarga da conta, com apenas uma chance. Quanto mais você recarregar, maior será a recompensa, sendo a maior recompensa de 2999,99;
"
                            ],
                            [
                                "content" => "2.Depósito sem limite. Recompensas previstas para serem atualizadas em 10 minutos. Por favor, aguarde a distribuição da recompensa;
"
                            ],
                            [
                                "content" => "3.As recompensas recebidas só podem ser resgatadas após Hoje00:00:00. O resgate só pode ser feito manualmente no APP/iOS、APP/Android、PC/Windows.
"
                            ],
                            [
                                "content" => "4.As recompensas recebidas expirarão 1 dias após o término de cada ciclo. As recompensas expiradas serão canceladas automaticamente;
"
                            ],
                            [
                                "content" => "5.O bônus (principal + bônus) concedido neste evento requer 3 vezes de apostas válidas antes de poder ser sacado, e as apostas são limitadas a Pescaria:Todos os jogos, Slots:Todos os jogos;
"
                            ],
                            [
                                "content" => "6.Este evento é limitado a operações normais realizadas pelo titular da conta. É proibido alugar, usar plug-ins externos, robôs, apostar em contas diferentes, brushing mútuo, arbitragem, interface, protocolo, exploração de vulnerabilidades, controle de grupo ou outros meios técnicos para participar. Caso contrário, as recompensas serão canceladas ou deduzidas, a conta será congelada ou até mesmo adicionada à lista negra;
"
                            ],
                            [
                                "content" => "7.Para evitar diferenças na compreensão do texto, a plataforma reserva-se o direito de interpretação final deste evento."
                            ]
                        ]
                    ],
                    "basic_config" => [
