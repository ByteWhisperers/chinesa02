<div class="startbar d-print-none">
    ...
    <div class="brand">
        <a href="index.php" class="logo">
            <span class="">
                <img src="../uploads/<?= $dataconfig['logo'] ?>" alt="logo-small" class="logo-sm logo-light">
            </span>
            <span class="logo-sm-small" style="display:none;"> <!-- Logo menor quando minimizada -->
                <img src="../uploads/<?= $dataconfig['logo'] ?>" alt="logo-small" class="logo-sm-small">
            </span>
            <span class="badge rounded text-success bg-success-subtle ms-1">.</span>
        </a>
    </div>
        ...
        <div class="startbar-collapse" id="startbarCollapse" data-simplebar>
            <div class="d-flex align-items-start flex-column w-100">
                ...
                <ul class="navbar-nav mb-auto w-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#promocoes" data-bs-toggle="collapse" role="button" aria-expanded="false"
                            aria-controls="promocoes">
                            <i class="iconoir-message-alert menu-icon"></i>
                            <span>Promoções</span>
                        </a>
                        <div class="collapse " id="promocoes">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="promocao">Gerenciar Promoções</a>
                                </li><!--end nav-item-->
                            </ul><!--end nav-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#gateway" data-bs-toggle="collapse" role="button"
                            ...
                            <span>Gateway</span><span class="badge rounded text-success bg-success-subtle ms-1">1</span>
                        </a>
                        <div class="collapse " id="gateway">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="suitpay">Credenciais Gateway</a>
                                </li><!--end nav-item-->
                            </ul><!--end nav-->
                        </div><!--end startbarEmailTemplates-->
                    </li><!--end nav-item-->
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#chavesapi" data-bs-toggle="collapse" role="button"
                            ...
                            <span>Gerenciar Chaves</span><span class="badge rounded text-success bg-success-subtle ms-1">1</span>
                        </a>
                        <div class="collapse " id="chavesapi">
                            <ul class="nav flex-column">
                                <li class="nav-item">
                                    <a class="nav-link" href="api">Gerenciar Credenciais</a>
                                </li><!--end nav-item-->
                            </ul><!--end nav-->
                        </div><!--end startbarAuthentication-->
                    </li><!--end nav-item-->
                ...
                <div class="update-msg text-center">
                    ...
                    <a href="https://wa.me/5537998281149" class="btn text-primary shadow-sm rounded-pill">Suporte</a>
                </div>
            </div>
