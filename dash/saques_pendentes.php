                                        ...
                                        <tbody>
                                            ...
                                            if ($result_usuarios && mysqli_num_rows($result_usuarios) > 0) {
                                                while ($usuario = mysqli_fetch_assoc($result_usuarios)) {
                                                    ...
                                                    $chavepixuser = localizarchavepixall($usuario['pix']);
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span><?= $chavepixuser['pix_account'] ?></span>
                                                            <button type="button" class="btn btn-primary btn-clipboard ms-2"
                                                                data-clipboard-text="<?= $chavepixuser['pix_account']; ?>">
                                                                <i class="far fa-copy"></i>
                                                            </button>
                                                        </td>
                                                        <td>
                                                            <span><?= $chavepixuser['pix_id']; ?></span>
                                                            <button type="button" class="btn btn-primary btn-clipboard ms-2"
                                                                data-clipboard-text="<?= $chavepixuser['pix_id']; ?>">
                                                                <i class="far fa-copy"></i>
                                                            </button>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-primary btn-clipboard ms-2"
                                                                data-clipboard-text="<?= $tipoChavePix; ?>">
                                                                <i class="far fa-copy"></i>
                                                            </button>
                                                        </td>
                                                        <td><?= $cargo_badge; ?></td>
                                                        <td>
                                                            <button class="btn btn-warning btn-edit-saque"
                                                                ...
                                                                data-chave="<?= $chavepixuser['pix_account']; ?>"
                                                                data-usuario="<?= $mobile; ?>"
