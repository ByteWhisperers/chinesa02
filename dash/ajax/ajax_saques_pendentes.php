                        ...
                        <form role="form" method="post">
                            <div class="box-body">
                                ...
                                <div class="phillyps-form">
                                    ...
                                    <input type="text" class="phillyps-form" id="exampleInputEmail1" value="<?= $data_return['nome']; ?>" readonly>
                                </div>
                                <div class="phillyps-form">
                                    <label for="exampleInputEmail1">Tipo Pix</label>
                                    <input type="text" class="phillyps-form" id="exampleInputEmail1" value="<?= $data['tipo']; ?>" readonly>
                                </div>
                                <div class="phillyps-form">
                                    <label for="exampleInputPassword1">Key Pix</label>
                                    <input type="text" class="phillyps-form" value="<?= $data['pix']; ?>">
                                </div>
                            </div>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            ...
                            <div class="phillyps-form">
                                ...
                                <input type="text" class="phillyps-form" id="nomeUser" value="<?= $data_return['nome']; ?>" readonly>
                            </div>
                            <div class="phillyps-form">
                                <label for="tipoPix">Tipo Pix</label>
                                <input type="text" class="phillyps-form" id="tipoPix" value="<?= $data['tipo']; ?>" readonly>
                            </div>
                            <div class="phillyps-form">
                                <label for="keyPix">Key Pix</label>
                                <input type="text" class="phillyps-form" id="keyPix" value="<?= $data['pix']; ?>">
                            </div>
